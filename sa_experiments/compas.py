...
if __name__ == "__main__":
    ...
    for model_path in model_paths:
        ...
        model.load_state_dict(torch.load("../saved_models/compas/{}".format(model_path)))
        model.eval()

        _, _, X_val, _, _, y_val, sens_idx = preprocess_compas(seed)
        X_val = X_val
        y_val = y_val
        ...
        obj = SimulatedAnnealingRepair(
            ...
            logfile="./sa_runs_1hr/compas_sa_{}.log".format(seed),
        )
